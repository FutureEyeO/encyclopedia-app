            ...
            try {
                ...
                await Api.registerUser(userData).then(async res => {
                    ...
                    if (res.status == 200) {
                        ...
                        await loginApiContext(userCredentials, context.dispatch).then(() => {
                            setIsFetching(false)
                        })
                    }
                })
                ...
                <div className="card-body">
                    <form className="row g-4 " onSubmit={handleSubmit}>
                        ...
                        <div className="g-4 mb-5 mt-5">
                            ...
                            <div id="preview">
                                <div className={`card-img-top profileDiv-coverImg`} id="preview-coverImg" >
                                    <div className={`profileDiv-profileImg shadow-lg p-1 bg-body rounded-circle`} id="preview-profileImg" >
                                    </div>
                                </div>
                            </div>
